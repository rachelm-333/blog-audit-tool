...
const CHECK_DEFS: CheckDef[] = [
  ...
  { id: 'MAC-01', parameter: 'URL Structure',        phase: 'macro', maxPoints: 3 },
  { id: 'MAC-02', parameter: 'Meta Title',           phase: 'macro', maxPoints: 2 },
  { id: 'MAC-03', parameter: 'Meta Description',     phase: 'macro', maxPoints: 1 },
  { id: 'MAC-04', parameter: 'Keyword Optimisation', phase: 'macro', maxPoints: 4 },
  { id: 'MAC-05', parameter: 'Article Schema',       phase: 'macro', maxPoints: 3 },
  { id: 'MAC-06', parameter: 'FAQ Schema',           phase: 'macro', maxPoints: 4 },
  { id: 'MAC-07', parameter: 'Brand Schema',         phase: 'macro', maxPoints: 2 },
  { id: 'MAC-08', parameter: 'Author Schema',        phase: 'macro', maxPoints: 3 },
  { id: 'MAC-09', parameter: 'Pillar Link',          phase: 'macro', maxPoints: 7 },
  { id: 'MAC-10', parameter: 'Child Links',          phase: 'macro', maxPoints: 3 },
  { id: 'MAC-11', parameter: 'Internal Links',       phase: 'macro', maxPoints: 3 },
  // Micro Architecture — 37 pts
  { id: 'MIC-01', parameter: 'Heading Structure',    phase: 'micro', maxPoints: 3 },
  { id: 'MIC-02', parameter: 'Keyword in Heading',   phase: 'micro', maxPoints: 6 },
  { id: 'MIC-03', parameter: 'Question Headlines',   phase: 'micro', maxPoints: 6 },
  { id: 'MIC-04', parameter: 'Heading Depth',        phase: 'micro', maxPoints: 3 },
  { id: 'MIC-05', parameter: 'Answer Clarity',       phase: 'micro', maxPoints: 5 },
  { id: 'MIC-06', parameter: 'Content Lists',        phase: 'micro', maxPoints: 5 },
  { id: 'MIC-07', parameter: 'Comparison Content',   phase: 'micro', maxPoints: 4 },
  { id: 'MIC-08', parameter: 'Paragraph Length',     phase: 'micro', maxPoints: 5 },
  // E-E-A-T & Voice — 28 pts
  { id: 'EAT-01', parameter: 'Data & Stats',         phase: 'eat', maxPoints: 6 },
  { id: 'EAT-02', parameter: 'Experience Signals',   phase: 'eat', maxPoints: 4 },
  { id: 'EAT-03', parameter: 'Authenticity Signals', phase: 'eat', maxPoints: 2 },
  { id: 'EAT-04', parameter: 'Expert Citations',     phase: 'eat', maxPoints: 5 },
  { id: 'EAT-05', parameter: 'Outbound Links',       phase: 'eat', maxPoints: 4 },
  { id: 'EAT-06', parameter: 'External References',  phase: 'eat', maxPoints: 2 },
  { id: 'EAT-07', parameter: 'Writing Style',        phase: 'eat', maxPoints: 2 },
  { id: 'EAT-08', parameter: 'Natural Language',     phase: 'eat', maxPoints: 3 },
];
