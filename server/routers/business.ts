...
const SaveBusinessInput = z.object({
  ...
  targetAudienceProblems: z.string().nullable().optional(),
  brandVoiceAnalysis: z.string().nullable().optional(),
  ...
  startScrape: publicProcedure
    .input(
      ...
      const updateData: Partial<InsertBusiness> = {
        ...
        targetAudienceProblems: scrapeResult.targetAudienceProblems.value ?? null,
        brandVoiceAnalysis: scrapeResult.brandVoiceAnalysis.value ?? null,
    ...
    .query(async ({ input }) => {
      ...
      return {
        ...
        business: {
          ...
          targetAudienceProblems: biz.targetAudienceProblems ?? "",
          brandVoiceAnalysis: biz.brandVoiceAnalysis ?? "",
  ...
  save: publicProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      const fieldMap: Record<string, unknown> = {
        ...
        targetAudienceProblems: input.targetAudienceProblems,
        brandVoiceAnalysis: input.brandVoiceAnalysis,
